  ...
  <div>
    <section class="page-hero">
      <div class="container">
        ...
        <p>
          Soluciones web personalizadas diseñadas para impulsar el crecimiento
          de tu negocio.
        </p>
      </div>
    </section>
          ...
          >
            ...
            <div class="service-card__actions">
              <RouterLink
                ...
                >Solicitar</RouterLink
              >
              <button
                @click.stop="selectedService = service"
      ...
      <div class="modal" @click.stop>
        ...
        <div class="modal__body">
          ...
          <div v-if="selectedService.addOns" class="modal__addons">
            ...
            <div
              v-for="addon in selectedService.addOns"
              :key="addon.name"
              class="modal__addon-row"
            >
          ...
          <div class="modal__footer">
            <RouterLink
              :to="`/contacto?service=${selectedService.id}`"
              class="btn btn--primary btn--full"
              >Solicitar Servicio</RouterLink
            >
            <button @click="selectedService = null" class="btn btn--outline">
              Cerrar
            </button>
          </div>
        </div>
    ...
    <div class="container--mid">
      <div class="cta-block">
        ...
        <p>
          Contáctanos para un servicio personalizado ajustado a tus necesidades.
        </p>
        <div class="btn-group btn-group--center">
          <RouterLink to="/contacto" class="btn btn--primary btn--lg"
            >Solicitar Presupuesto</RouterLink
          >
        </div>
      </div>
    </div>
...
useSeo({
  ...
  description:
    "Web corporativa desde €499, e-commerce desde €999, artículos SEO desde €150 y mantenimiento mensual desde €99. Presupuesto sin compromiso.",
  path: "/servicios",
  schema: {
    ...
    itemListElement: [
      {
        ...
        description: "Diseño web profesional desde €499",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "E-commerce Profesional",
        description: "Tienda online completa desde €999",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Artículos SEO",
        description: "Contenido optimizado desde €150 por artículo",
      },
      {
        "@type": "ListItem",
        position: 4,
        name: "Mantenimiento y Soporte",
        description: "Mantenimiento mensual desde €99/mes",
      },
    ],
  },
});
...
const services = ref([
  {
    ...
    longDescription:
      "Crea una presencia profesional en línea con un sitio web moderno, responsivo y optimizado para conversión.",
    price: "499",
  ...
  },
  {
    ...
    longDescription:
      "Tienda online completa con carrito de compras, pasarela de pagos, gestión de inventario y análisis de ventas.",
    price: "999",
  ...
  },
  {
    ...
    longDescription:
      "Artículos de blog optimizados para SEO que atraen tráfico orgánico de calidad.",
    price: "150",
    ...
    process: [
      {
        ...
        description: "Identificamos oportunidades SEO",
      },
  ...
  },
  {
    ...
    longDescription:
      "Plan de mantenimiento mensual con actualizaciones de seguridad, backups, optimización y soporte técnico prioritario.",
    price: "99",
    delivery: "Mensual",
    includes: [
