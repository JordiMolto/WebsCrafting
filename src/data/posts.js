export const posts = [
  {
    ...
    icon: "🚀",
    excerpt:
      "Descubre las tecnologías y tendencias que dominarán el desarrollo web este año.",
    ...
    conclusion:
      "Si quieres mantenerse al día con la industria, es importante aprender estas tecnologías y entender cómo aplicarlas en tus proyectos.",
    tags: ["desarrollo", "web", "tendencias", "tecnologia"],
  },
  {
    id: 2,
    slug: "guia-completa-seo-tecnico",
    title: "Guía Completa de SEO Técnico",
    category: "SEO",
    icon: "📊",
    excerpt:
      "Todo lo que necesitas saber sobre SEO técnico para mejorar tu posicionamiento en Google.",
    ...
    conclusion:
      "Implementar una sólida estrategia de SEO técnico es el primer paso hacia el éxito en buscadores.",
    tags: ["seo", "tecnico", "google", "ranking"],
  },
  {
    id: 3,
    slug: "ecommerce-estrategias-conversion",
    title: "E-commerce: Estrategias para Aumentar Conversiones",
    category: "Marketing",
    icon: "💰",
    excerpt:
      "Técnicas probadas para mejorar la tasa de conversión en tu tienda online.",
    ...
    conclusion:
      "Pequeñas mejoras en la experiencia de usuario pueden resultar en aumentos significativos de conversión.",
    tags: ["ecommerce", "marketing", "conversiones", "ventas"],
  },
  {
    id: 4,
    slug: "diseno-responsivo-guia",
    title: "Diseño Responsivo: Guía para Desarrolladores",
    category: "Diseño",
    icon: "📱",
    excerpt:
      "Cómo crear sitios web que se adapten perfectamente a cualquier dispositivo.",
    author: "Sofia López",
    ...
    conclusion:
      "Un sitio web responsivo no es una opción, es una necesidad para el éxito online.",
    tags: ["diseño", "responsive", "mobile", "css"],
  },
  {
    id: 5,
    slug: "marketing-digital-estrategia-completa",
    title: "Marketing Digital: Estrategia Completa",
    category: "Marketing",
    icon: "📈",
    excerpt:
      "Crea una estrategia de marketing digital integral para tu negocio.",
    author: "Carlos Martínez",
    ...
    conclusion:
      "Una estrategia de marketing digital bien ejecutada puede transformar tu negocio.",
    tags: ["marketing", "digital", "estrategia", "negocio"],
  },
  {
    id: 6,
    slug: "seguridad-web-protege-tu-sitio",
    title: "Seguridad Web: Protege tu Sitio",
    category: "Desarrollo",
    icon: "🔒",
    excerpt:
      "Medidas esenciales para proteger tu sitio web de vulnerabilidades.",
    author: "Miguel Santos",
    ...
    conclusion:
      "La inversión en seguridad web se paga sola evitando brechas de datos costosas.",
