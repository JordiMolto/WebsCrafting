...
export function useSeo({ title, description, path = '/', type = 'website', schema = null } = {}) {
  const fullTitle = title ? `${title} | ${SITE_NAME}` : `${SITE_NAME} | Diseño y Desarrollo Web a Medida`
